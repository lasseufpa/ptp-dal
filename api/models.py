...
class Dataset(db.Model):
    ...
    calibration_duration        = db.Column(db.Integer)
    pipeline_bbu                = db.Column(db.Integer)
    pipeline_rru                = db.Column(db.Integer)
    start_time                  = db.Column(db.DateTime)
    departure_ctrl              = db.Column(db.Boolean)
    departure_gap_dl            = db.Column(db.Integer)
    departure_gap_ul            = db.Column(db.Integer)
    tstamp_latency_corr_bbu_tx  = db.Column(db.Integer)
    tstamp_latency_corr_bbu_rx  = db.Column(db.Integer)
    tstamp_latency_corr_rru1_tx = db.Column(db.Integer)
